    ...
    //检测特殊函数
        ...
        */
        ...
        for(int i=0;i<shortened_str.length();i++){
            if(shortened_str[i]=='X'||shortened_str[i]=='s'||shortened_str[i]=='c'||shortened_str[i]=='t'||shortened_str[i]=='l'||shortened_str[i]=='a'||shortened_str[i]=='e'||shortened_str[i]=='('||shortened_str[i]==')'||shortened_str[i]=='+'||shortened_str[i]=='-'||shortened_str[i]=='*'||shortened_str[i]=='/'||shortened_str[i]=='^'||(shortened_str[i]>='0'&&shortened_str[i]<='9')){}
            else return false;
        }
